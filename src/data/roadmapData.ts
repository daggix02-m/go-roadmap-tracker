...
export const PART_INFO: Record<string, { name: string; description: string; badge: string }> = {
  A: {
    name: 'Part A — Core Go Foundations',
    description:
      'Get fluent enough in Go that the application never fights you. Not mastery — fluency.',
    badge: 'Phases 0–3'
  },
  B: {
    name: 'Part B — Build TaskFlow',
    description:
      'Build one application continuously. Every phase adds a real feature to TaskFlow — you feel friction before every new concept, and that friction is the lesson.',
    badge: 'Phases 4–18'
  },
  C: {
    name: 'Part C — Production Engineering',
    description:
      'Database discipline, observability, real concurrency, build tooling, and deploying to a real Linux server.',
    badge: 'Phases 19–24'
  },
  D: {
    name: 'Part D — API & Advanced Backend',
    description:
      'A JSON REST layer over TaskFlow, filtering/sorting/pagination, token auth & rate limiting, background jobs, and the final capstone.',
    badge: 'Phases 25–28'
  }
};

export const ROADMAP_PARTS_META = PART_INFO;

export const ROADMAP_METHOD =
...
export const WORKING_PRINCIPLE: { step: string }[] = [
